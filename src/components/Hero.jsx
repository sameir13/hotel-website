...
const reviewData = [
  {
    commit: "Supreme Home's flavors dance, a culinary symphony on my palate",
    review: "5",
    name: "John",
    time: "2021-08-01",
  },
  {
    commit: "Divine dining, Supreme Home crafts perfection in every bite. 😋",
    review: "4",
    name: "Mary",
    time: "2021-08-02",
  },
  {
    commit: "A gastronomic journey, Supreme Home elevates taste to new heights.",
    review: "3",
    name: "David",
    time: "2021-08-03",
  },
  {
    commit: "Exquisite dishes, Supreme Home turns dining into a masterpiece",
    review: "4",
    name: "Sarah",
    time: "2021-08-04",
  },
  {
    commit: "Supreme Home: where each dish is a canvas of delight....",
    review: "5",
    name: "Michael",
    time: "2021-08-05",
  },
  {
    commit: "Incredible fusion, Supreme Home redefines the art of dining.",
    review: "2",
    name: "Emily",
    time: "2021-08-06",
  },
  ...
  return (
    <>
      ...
      <div className="bg-[url('/image/sign/hero2.webp')] h-full py-10 lg:h-[100vh] bg-center bg-cover">
        <Slider {...settings} className=" max-w-[900px] m-auto w-[85%] mt-32">
          {reviewData.map((v, i) => {
            return (
              <div key={i} className=" px-2 lg:px-4">
                <div className=" bg-white flex flex-col justify-center items-center gap-3 px-4 py-8">
                  ...
                  <p className="text-center text-[rgb(94,94,94)] text-sm line-clamp-2">
                    {v.commit}
                  </p>
      ...
      <div className=" max-w-[1200px] m-auto py-[50px]">
